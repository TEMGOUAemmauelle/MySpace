...
import AnimatedSphere from "../components/AnimatedVisual"
// Memoized Components
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen pt-24 pb-10 md:justify-between gap-8 sm:gap-12 lg:gap-20" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left pt-64  lg:text-left order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
